...
class TestCase {
    public:
        ...
        void testCheckerPieceInitialization() {
            ...
            assert(redPiece.getPos() == std::make_tuple(5, 2));
            assert(blackPiece.getPos() == std::make_tuple(2, 3));
        ...
        void testCheckerPieceKingPromotion() {
            ...
            redPiece.changePos(std::make_tuple(0, 2));
            blackPiece.changePos(std::make_tuple(7, 3));
